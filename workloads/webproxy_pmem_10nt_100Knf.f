...
set $nfiles=100K
set $nthreads=10
set $meandirwidth=1000000set $meanfilesize=32kset $meaniosize=16kset $iosize=1mdefine fileset name=bigfileset,path=$dir,size=$meanfilesize,entries=$nfiles,dirwidth=$meandirwidth,prealloc=80
