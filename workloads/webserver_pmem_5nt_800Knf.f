...
set $nfiles=800K
set $nthreads=5
set $meandirwidth=20set $filesize=cvar(type=cvar-gamma,parameters=mean:65536;gamma:1.5)set $iosize=1mset $meanappendsize=8kdefine fileset name=bigfileset,path=$dir,size=$filesize,entries=$nfiles,dirwidth=$meandirwidth,prealloc=100,readonly
